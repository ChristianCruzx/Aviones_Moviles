                            ...
                            <table class="table table-bordered table-striped mb-0 " id="example" style="">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">CuentaOrigen</th>
                                        <th scope="col">CuentaDestino</th>
                                ...
                                <tbody>
                                    ...
                                    for (Transferencia t : c.getListaTranferencias()) {
                                            i++;%>


                                    <tr>
                                        <td> <%= i%>   </td>
                                        <td> <%= t.getCuenta_origen().getNum_cuenta()%> </td>
                                        <td><%= t.getCuenta_destino().getNum_cuenta() %> </td>
                                        <td><%= t.getMonto() %> </td>
                                        <td><%= t.getFecha() %> </td>
